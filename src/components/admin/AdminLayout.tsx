      ...
      <div style={{
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", minWidth: 0 }}>
          <header style={{
            ...
            background: "rgba(10,14,35,0.6)", backdropFilter: "blur(16px)",
            WebkitBackdropFilter: "blur(16px)",
            borderBottom: "1px solid rgba(255,255,255,0.07)",
            boxShadow: "0 1px 0 rgba(255,255,255,0.04)",
          }}>
            <SidebarTrigger className="mr-4" style={{ color: "rgba(148,163,184,0.7)" }} />
            <h2 style={{
          ...
          <main style={{ flex: 1, padding: "24px", overflowY: "auto", background: "transparent" }}>
            {children}
          </main>
        </div>
      </div>
